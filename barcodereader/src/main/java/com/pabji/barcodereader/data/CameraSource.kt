...
internal class CameraSource(
    ...
    // These instances need to be held onto to avoid GC of th eir underlying resources.  Even though
...
// detection takes a non-trivial amount of time.
    ...
    private fun createPreviewBuffer(previewSize: Size?): ByteArray? {
        ...
        return previewSize?.run {
            val sizeInBits = height.toLong() * width * bitsPerPixel
...
// still account for it.
        ...
        ): IntArray? { // The camera API uses integers scaled by a factor of 1000 instead of floating-point frame
// rates.
